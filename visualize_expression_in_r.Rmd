...
```{r}
data_fp <- "spikein_data/nobatch/SpikeinWorkshop_nobatch/differential_expression/SpikeinWorkshop_nobatch/SpikeinWorkshop_nobatch_stats.tsv"
design_fp <- "spikein_data/nobatch/SpikeinWorkshop_nobatch/differential_expression/input_design.tsv"
...
ggplot(full_data_df, aes(x=log2Fold)) + geom_histogram(bins=100)
```
